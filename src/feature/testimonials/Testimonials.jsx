...
export default function Testimonials() {
  ...
  return (
		<div
			className="w-full sm:px-14 xl:px-[5.6em] md:pt-16 pt-10 px-5 pb-3 overflow-x-hidden"
			id="testimonials">
			...
			<div className="w-full grid gap-3 mt-5 lg:grid-cols-3 lg:gap-x-8 overflow-x-hidden">
